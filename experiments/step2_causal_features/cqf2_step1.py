...
# Import ONLY regime features for Step 1
from regime_tools import add_regime_features
...
class OptimalCQF:
    ...
    def create_preprocessor(self, df: pd.DataFrame) -> Pipeline:
        ...
        cqf_features = [
            ...
            # Step 1: ONLY regime features (testing incremental enhancement)
...
def load_and_prepare_data(data_file: str, config_file: str = "config.yaml") -> pd.DataFrame:
    ...
    # Step 1: Add ONLY regime features (incremental enhancement)
    df_processed = add_regime_features(df_processed)
    logger.info("Added Step 1 regime features: vix_regime, vol_cluster, stress_score")
