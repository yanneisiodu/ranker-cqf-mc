...
def evaluate_model(args):
    ...
    if 'last' in df_eval_features_intermediate.columns:
        ...
        df_eval_features_intermediate['price_change_1d'] = np.where(last_shifted.fillna(0) != 0, (df_eval_features_intermediate['last'] - last_shifted) / last_shifted, 0)
    else: df_eval_features_intermediate['price_change_1d'] = 0
    ...
    else: df_eval_features_intermediate['iv_change_1d'] = 0
