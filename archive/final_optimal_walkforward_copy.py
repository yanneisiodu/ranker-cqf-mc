...
def main():
    ...
    optimal_params = {
        ...
        'portfolio_stop_loss_pct': 0.65,  # 65% portfolio stop-loss (vs 50% in Trial #45)
        ...
        'enable_consecutive_loss_breaker': True,  # Enabled (vs disabled in Trial #45)
        'max_consecutive_losses': 45,  # 45 consecutive losses limit
